...
if __name__ == '__main__':
    setup_dict = {
        'name': 'calculatePlateTemperature4AF-R2023b',
        'version': '23.2',
        'description': 'A Python interface to calculatePlateTemperature4AF',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'calculatePlateTemperature4AF'
        ],
        'package_data': {'calculatePlateTemperature4AF': ['*.ctf']}
    }
